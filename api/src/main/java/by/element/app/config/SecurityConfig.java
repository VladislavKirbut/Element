package by.element.app.config;

import by.element.app.models.security.AccessTokenProperties;
import by.element.app.service.authentication.AccessTokenService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, AccessTokenService accessTokenService) throws Exception {
        return httpSecurity
                .formLogin(config -> config
                        ...
                        .defaultSuccessUrl("/element/chatPage"))
